    ...
    <div className="ShopingCartBodySmall">
      ...
      <div className="ShopingCartBodySmallTable">
        ...
        <div className="ShopingCartBodyRow">
          <div className="ShopingCartBodyRowImgBox">
            <div className="ShopingCartBodyRowImgBox1">
              <img className="img" src="https://preview.colorlib.com/theme/footwear/images/item-6.jpg" alt="" />
            </div>
            <p>Product Name</p>
          </div>
        ...
        <div className="ShopingCartBodyRow">
          <div className="ShopingCartBodyRowImgBox">
            <div className="ShopingCartBodyRowImgBox1">
              <img className="img" src="https://preview.colorlib.com/theme/footwear/images/item-7.jpg" alt="" />
            </div>
            <p>Product Name</p>
          </div>
          <div className="ShopingCartBodyRow2">
        ...
        <div className="ShopingCartBodyRow">
          <div className="ShopingCartBodyRowImgBox">
            <div className="ShopingCartBodyRowImgBox1">
              <img className="img" src="https://preview.colorlib.com/theme/footwear/images/item-8.jpg" alt="" />
            </div>
            <p>Product Name</p>
          </div>
          <div className="ShopingCartBodyRow2">
      ...
      <div className="ShopingCartBodyCalBox">
        <div className="Nav">
          <input type="text" className="Coupon" placeholder="Your Coupon Number....." />
          <div className="Nav2">
            <p>Apply Coupon</p>
          </div>
        </div>
      ...
      <div className="ShopingCartBodySmallRelatedBox">
        <div className="ShopingCartBodySmallRelatedBoxs">
          <div className="imgBox">
              <img className="Imgg" src="https://preview.colorlib.com/theme/footwear/images/item-1.jpg" alt="" />
          </div>
        ...
        <div className="ShopingCartBodySmallRelatedBoxs">
          <div className="imgBox">
          <img className="Imgg" src="https://preview.colorlib.com/theme/footwear/images/item-2.jpg" alt="" />
        ...
        <div className="ShopingCartBodySmallRelatedBoxs">
          <div className="imgBox">
          <img className="Imgg" src="https://preview.colorlib.com/theme/footwear/images/item-3.jpg" alt="" />
        ...
        <div className="ShopingCartBodySmallRelatedBoxs">
          <div className="imgBox">
          <img className="Imgg" src="https://preview.colorlib.com/theme/footwear/images/item-4.jpg" alt="" />
